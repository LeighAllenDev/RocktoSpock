...
### Site Features
 ...
 #### Header
The site has a header that tells the user the name of the game. It has a light background which gives contrast against the rest of the page.
![Screenshot of my title](/assets/images/title.jpeg)

 #### Action Message
There is a message at the top of the page that tells the customer what they should do.
![Make your move](./assets/images/action.jpeg)
...
![Icon with hover shade](image-1.png)

#### Results
![Results text](image.png)

#### Score board
There is a score board that shows the users and computers scores:
![Score Board](./assets/images/scores.jpeg)

#### Play Button
At the end of the game, when the score limit is reach, a button appears to ask the user if they would like to play again. If they click the button the score resets.

![Play Button](image-2.png)
...
![SweetAlerts Win](./assets/images/SAwin.jpeg)![SweetAlerts Loose](./assets/images/SAloose.jpeg)![SweetAlerts Draw](./assets/images/SAdraw.jpeg)
...
* Add the rules to the page in a drop down menu for users that aren't familiar with how to play the game.
...
I have tested my project on some offical validators, the results are as follows:
...
JS hint:
![JSHint](./assets/images/JSHint.jpeg)
The JS Hint testing comes back with Swal being an undefined variable. The reason for this is that it doesnt recognise the imported library for the Sweet Alerts. 
